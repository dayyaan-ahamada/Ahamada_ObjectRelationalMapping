...
public class CatalogueTest {
    ...
    public void setUp() {
        cat = new Catalogue();
//		Si votre Catalogue est un Singleton, il faut changer la ligne précédente
//		puis vider le Catalogue avec la méthode clear() comme indiqué à la ligne suivante
		cat.clear();
    }
    ...
    public void testClear() {
        ...
        cat.clear();
        String resultatAttendu = "\n" + "Montant total TTC du stock : 0,00 €";
        assertEquals("Le catalogue doit être vide", resultatAttendu, cat.toString());
    }
